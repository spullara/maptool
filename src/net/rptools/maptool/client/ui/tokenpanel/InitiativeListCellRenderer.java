...
public class InitiativeListCellRenderer extends JPanel implements ListCellRenderer {
	 ...
	 */
	public static final Icon CURRENT_INDICATOR_ICON = new ImageIcon(InitiativePanel.class.getClassLoader().getResource("net/rptools/maptool/client/image/currentIndicator.png"));
