...
public class AddTokenStateMacro implements Macro {
	 ...
	 *            Name of the new overlay.
	 * @param color
	 *            The color of the yield
	 * @param width
	 *            The width of the yield
	 * @return The new token overlay.
	 */
	 ...
	 * 
	 * @param name
	 *            The name or hex value of a color.
	 * @return The color decoded from the name or the <code>Color.RED</code> if the passed name was <code>null</code>;
	 */
	 ...
	 * 
	 * @param name
	 *            The decimal value of the integer.
	 * @param defaultValue
	 *            The default value for the number.
	 * @return The number parsed from the name or the <code>defaultValue</code> if the passed name was <code>null</code>
	 *         ;
	 */
	 ...
	 * 
	 * @param name
	 *            The name or abbreviation of a quadrant value
	 * @return The quadrant representing the passed corner name of the <code>Quadrant.SOUTH_EAST</code> if the passed
