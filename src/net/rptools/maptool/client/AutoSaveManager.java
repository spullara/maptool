...
public class AutoSaveManager implements ActionListener {
	...
	/**
	 * Queries the auto-save increment from {@link AppPreferences} and starts a new
	 * timer.
	 */
	public void restart() 	{
	...
	/**
	 * Applications can use this to pause the timer.  Each call toggles the state of the timer,
	 * or the {@link #restart()} method can be called at any time to reset and start the timer.
	 */
	public void pause() {
