...
public class StrListFunctions extends AbstractFunction {
	public StrListFunctions() {
		super(1, UNLIMITED_PARAMETERS, "listGet", "listDelete", "listCount", "listFind", "listContains",
				"listAppend", "listInsert", "listReplace", "listSort", "listFormat");
	}
	...
	throws ParameterException {
		...
		int minParams = 2;
		int maxParams = minParams + 1;
		checkVaryingParameters("listDelete()", minParams, maxParams, parameters, new Class[] {null, BigDecimal.class, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	throws ParameterException {
		...
		int minParams = 1;
		int maxParams = minParams + 1;
		checkVaryingParameters("listCount()", minParams, maxParams, parameters, new Class[] {null, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	throws ParameterException {
		...
		int minParams = 2;
		int maxParams = minParams + 1;
		checkVaryingParameters("listFind()", minParams, maxParams, parameters, new Class[] {null, null, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	public Object listContains(List<Object> parameters, String listStr, String lastParam, List<String> list)
	throws ParameterException {
		Object retval = "";
		String delim = ",";
		...
		int minParams = 2;
		int maxParams = minParams + 1;
		checkVaryingParameters("listContains()", minParams, maxParams, parameters, new Class[] {null, null, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	throws ParameterException {
		...
		int minParams = 2;
		int maxParams = minParams + 1;
		checkVaryingParameters("listAppend()", minParams, maxParams, parameters, new Class[] {null, null, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	throws ParameterException {
		...
		int minParams = 3;
		int maxParams = minParams + 1;
		checkVaryingParameters("listInsert()", minParams, maxParams, parameters, new Class[] {null, BigDecimal.class, null, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	throws ParameterException {
		...
		int minParams = 3;
		int maxParams = minParams + 1;
		checkVaryingParameters("listReplace()", minParams, maxParams, parameters, new Class[] {null, BigDecimal.class, null, String.class});
		if (parameters.size() == maxParams) {
			delim = lastParam;
		}
		parse(listStr, list, delim);
	...
	throws ParameterException {
		...
		int minParams = 2;
		int maxParams = minParams + 1;
		checkVaryingParameters("listSort()", minParams, maxParams, parameters, new Class[] {null, String.class, String.class});
	...
	throws ParameterException {
		...
		int minParams = 4;
		int maxParams = minParams + 1;
		checkVaryingParameters("listFormat()", minParams, maxParams, parameters,
...
<br>listSort():
{if( listSort("M3,M10,M1","A")=="M1, M10, M3" && listSort("M3,M10,M1","N")=="M1, M3, M10"
	, OK, Fail)}

<br>listFormat():
{if( listFormat("a,b,c","[[%list]]", "(%item)", "...")=="[[(a)...(b)...(c)]]"
	, OK, Fail)}
